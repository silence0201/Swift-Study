...
structs in Swift. Likewise, in Swift, 3 many of the classes in Foundation now
have struct counterparts specifically built for Swift. That said, we'll focus on
the differences between structs and classes in this chapter. Meanwhile, enums
behave in a way that's similar to structs.
